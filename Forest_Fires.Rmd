...
#Linear kernel
svm_linear = svm(area ~ ., data=train_data, kernel = 'linear', cost = 1)
...
tune_linear = tune(svm, area ~ .  data = train_data, kernel='linear',
...
#RBF kernel
svm_rbf = svm(area ~ ., data=train_data, kernel = 'radial', cost = 1)
...
#Tuning RBF kernel
tune_rbf = tune(svm, area ~ .,  data = train_data, kernel='radial',
...
# rmse
rmse(pred.xgb.train, area_ha[train.index]) # ~13.415
