...
set.seed(12345)
model.xgb <- xgboost(data=dtrain, objective="reg:linear", nrounds=nrounds.opt, max_depth = max_depth.opt, eta=0.005, subsample=subsample.opt, colsample_bytree=colsample.opt , verbose=0)
