...
* Predict the burned area of a forest fire, given the prevailing meteorological conditions at the time of fire detection.
    ...
    + Could also be re-framed as a multi-class classification problem, by dividing the fires into 
