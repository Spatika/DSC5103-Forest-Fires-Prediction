...
x.train <- model.matrix(area ~ ., data=data[train.index, ])[, -13]
y.train <- data[train.index, "area"]

dtrain <- xgb.DMatrix(data=x.train, label=y.train)

x.test <- model.matrix(area ~ ., data=data[test.index, ])[ ,-13]
y.test <- data[test.index, "area"]
...
# rmse
rmse(pred.xgb, y.test) # ~36.87052
```

### 5b. XGBoost Variable Importance Plot
