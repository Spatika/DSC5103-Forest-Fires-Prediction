...
algos <- c('xgbTree','svmRadial')

models <- caretList(log_area~., data=data_norm[train.index,], metric = 'RMSE', trControl=control, methodList=algos)
...
stack_lm <- caretStack(models, method='xgbTree',  trControl=stack_control)
