...
* One way to deal with this is by labeling the datapoints by their severity (small, medium, big, or small/others) and considering it as a classification problem. Sampling techniques like over- or under-sampling could also then be applied to the training set. 
