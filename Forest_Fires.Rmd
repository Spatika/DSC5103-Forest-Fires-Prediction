...
## Conclusion
* Its difficult to predict the exact area which would be affected by a Forest Fire since our data consists of a huge range of Area.
* We could probably segment the area into different classes of the Severity of Damage (Low, Mid, High and Fatal) and consider it as multi class problem.
