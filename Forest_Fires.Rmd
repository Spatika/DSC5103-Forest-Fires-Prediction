...
# inverse log - 1
test_pred_area_lm <- exp(predict(model_lm, newdata = data[test.index,])) - 1
...
5. Özbayoğlu, A. M., & Bozer, R. (2012). Estimation of the burned area in forest fires using computational intelligence techniques. Procedia Computer Science, 12, 282-287.
