...
* Due to the small size of the dataset and the skew towards small forest fires, the results vary noticeably with the train-validation split and may not be as accurate as possible.
* One way to deal with this is by labeling the datapoints by their severity (small, medium, big, or small/others) and considering it as multi-class problem. Sampling techniques like over- or under-sampling could also then be applied to the training set. 
