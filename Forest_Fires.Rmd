...
* The SVM models show decent performance in terms of RMSE, but lower interpretability.
* Hence, we can say that the burned area is indeed dependent on temperature, wind and rain. The other variables do not contribute much.
* The best and similar results obtained are by using SVM, KNN or a combination of both.
```{r results table, eval=TRUE, echo=TRUE, message=FALSE, tidy=TRUE, warning=FALSE}
