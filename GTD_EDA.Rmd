...
3. Codebook - https://www.start.umd.edu/gtd/downloads/Codebook.pdf
...
# load data
data <- read.csv(file = "data/globalterrorismdb_0718dist.csv", row.names = 1, stringsAsFactors = FALSE)
